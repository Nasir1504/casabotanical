...
export default function CollaborateForm() {
    ...
    return (
        <div className="collaborate-form-main h-auto max-xs:px-25 max-xxs:px-38">
            <form className="flex flex-col gap-6 ">
                <input
                    type="text"
                    placeholder="Full Name"
                    className="text-[1rem] max-xs:text-[0.8rem] max-md:rounded-md lg:rounded-lg"
                />
                <input
                    type="text"
                ...
                <PhoneInput
                    ...
                    value={phone}
                    onChange={setPhone}
                    className="phone-input flex text-[1rem] max-xs:text-[0.8rem] max-md:rounded-md lg:rounded-lg"
                />
                <input
                    type="text"
                ...
                <div>
                    <input type="checkbox" id="retailer" name="retailer"
                        className="text-[1rem] max-xs:text-[0.8rem]"
                    /> &nbsp;
                ...
                <div>
                    ...
                    /> &nbsp;
                    <label htmlFor="scales"
                        className="text-[1.2rem] max-xs:text-[0.8rem]"
                ...
                <select
                    className="bg-[#fff] p-[1em] text-[#000] text-[1rem] max-xs:text-[0.8rem] max-md:rounded-md lg:rounded-lg"
                    name="order" id="order"
                >
