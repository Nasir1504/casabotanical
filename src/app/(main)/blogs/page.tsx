...
export default function Blogs() {
    return (
        <div className="blogs-main bg-[#232321] flex flex-col justify-center items-center gap-20 max-xs:gap-10 pt-35">

            <h3 className="max-lg:text-[2.5rem] xl:text-[3.5rem] lg:text-[3rem] text-[#c5c5c5] uppercase">Blogs</h3>

            <section className="content-section w-[80%] grid grid-cols-[1fr_1fr_1fr] max-lg:grid-cols-[1fr_1fr] max-xs:grid-cols-[1fr] max-lg:gap-10 lg:gap-10 xl:gap-20 max-xs:mb-15">
                {
